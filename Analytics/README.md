...
1. [Módulo 01 — Fundamentos, Contexto e Importância](./01-Fundamentos-Contexto-e-Importancia/)
2. [Módulo 02 — Processo de Aplicação de Analytics](./02-Processo-de-Aplicacao-de-Analytics/)
3. [Módulo 03 — Abordagens: Descritiva, Preditiva e Prescritiva](./03-Abordagens-de-Analytics/)
4. [Módulo 04 — Ferramentas Principais de Analytics](./04-Ferramentas-de-Analytics/)
5. [Módulo 05 — Python para Análise de Dados](./05-Python-para-Analytics/)
6. [Módulo 06 — Linguagem R para Análise de Dados](./06-R-para-Analytics/)
7. [Módulo 07 — Python x R e Revisão de Fundamentos](./07-Python-vs-R-e-Revisao/)
8. [Módulo 08 — Estatística para Análise de Dados: Visão Geral](./08-Estatistica-para-Analise-de-Dados/)
9. [Módulo 09 — Análise Descritiva, População, Amostra e Variáveis](./09-Analise-Descritiva-Fundamentos/)
10. [Módulo 10 — Medidas de Tendência Central e Dispersão](./10-Medidas-de-Tendencia-Central-e-Dispersao/)
...
| Etapa | Foco                                                                     |
| ----- | ------------------------------------------------------------------------ |
| 01    | Conceito, evolução, definições, aplicações, ética e privacidade          |
| 02    | Fluxo completo: do objetivo ao feedback contínuo                         |
| 03    | Diferenças entre análise descritiva, preditiva e prescritiva             |
| 04    | Ferramentas por função: planilhas, estatística, BI, IA e dados em escala |
| 05-06 | Linguagens centrais (Python e R) e bibliotecas mais cobradas             |
| 07    | Comparação Python x R e revisão de fechamento dos fundamentos            |
| 08    | Papel da estatística na análise de dados (descritiva e inferencial)      |
| 09    | Conceitos-base: população, amostra, variáveis e escalas de mensuração    |
| 10    | Leitura de dados por centro e dispersão                                  |
...
## ✅ Como estudar esta trilha para prova
